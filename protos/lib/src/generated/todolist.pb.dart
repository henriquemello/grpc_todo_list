...
class User extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'User', package: const $pb.PackageName(_omitMessageNames ? '' : 'todolist'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..hasRequiredFields = false
  ;
...
class Tasks extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Tasks', package: const $pb.PackageName(_omitMessageNames ? '' : 'todolist'), createEmptyInstance: create)
    ..pc<Task>(1, _omitFieldNames ? '' : 'task', $pb.PbFieldType.PM, subBuilder: Task.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Tasks copyWith(void Function(Tasks) updates) => super.copyWith((message) => updates(message as Tasks)) as Tasks;
  ...
  @$pb.TagNumber(1)
  $core.List<Task> get task => $_getList(0);
}
...
class Empty extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Empty', package: const $pb.PackageName(_omitMessageNames ? '' : 'todolist'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
